...
use crate::curv::elliptic::curves::{secp256_k1::Secp256k1, Scalar};
use crate::round_based::containers::{
    push::{Push, PushExt},
    *,
};
use crate::round_based::{IsCritical, Msg, StateMachine};
...
pub struct Keygen {
    ...
    msgs1: Option<Store<BroadcastMsgs<gg20::party_i::KeyGenBroadcastMessage1>>>,
    msgs2: Option<Store<BroadcastMsgs<gg20::party_i::KeyGenDecommitMessage1>>>,
